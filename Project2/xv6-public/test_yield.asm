...
int main(int argcf, char* argv[]){
   ...
   f:	89 e5                	mov    %esp,%ebp
  11:	53                   	push   %ebx
  12:	bb 10 27 00 00       	mov    $0x2710,%ebx
  17:	51                   	push   %ecx
	int p, i;
	p = fork();
  ...
  32:	e8 39 04 00 00       	call   470 <printf>
			yield();
  37:	e8 47 03 00 00       	call   383 <yield>
		for(i = 0; i<NUM_LOOP; i++){
  ...
  5a:	e8 11 04 00 00       	call   470 <printf>
			yield();
  5f:	e8 1f 03 00 00       	call   383 <yield>
		for(i = 0; i<NUM_LOOP; i++){
  64:	83 c4 10             	add    $0x10,%esp
  67:	83 eb 01             	sub    $0x1,%ebx
  6a:	75 e4                	jne    50 <main+0x50>
  6c:	eb d6                	jmp    44 <main+0x44>
  6e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb e7 07 00 00       	mov    $0x7e7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 9c 0a 00 00       	mov    0xa9c,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 7c2:	00 00 00 
    if(p->s.size >= nunits){
